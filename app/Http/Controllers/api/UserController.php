...
class UserController extends Controller
{
    ...
    public function getParty(Request $request)
    {
        ...
        $party_ids_based_on_state = StateParties::where('state_id', $state_id)->pluck('party_id');
        $data = Parties::orderBy('english_party_name', 'asc')->where('is_deleted' , null)->wherein('id' , $party_ids_based_on_state)->get();
        return response()->json([
            'status' => 'success',
    ...
    public function getTemplate(Request $request)
    {
        ...
        if ($request->filter_ids) {
            $template = Template::where($where)->orderBy('id' , 'desc')->whereJsonContains('state_id' ,$user_details->state_id )
            ...
            $template = Template::where($where)->orderBy('id' , 'desc')->whereJsonContains('state_id' ,$user_details->state_id )->get();
        }
