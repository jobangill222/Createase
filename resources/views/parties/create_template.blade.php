    ...
    <div class="side-app">
        ...
        <div class="table-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <input type="file" class="form-control-file @error('background_image') is-invalid @enderror" name="background_image" accept="image/*" onchange="backgroundImage(event)">
                    @error('background_image')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                    @enderror
                    <img id="backgroundImagePreview" src="#" alt="Image Preview" style="display: none; max-width: 100%; margin-top: 10px;">
                </div>
                    </div>
                </div>
            </div>
