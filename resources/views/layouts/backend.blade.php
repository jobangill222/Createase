                ...
                <div class="container-fluid">
                    <div class="d-flex">
                        ...
                        <img src="{{Helper::frontendWithBaseUrl('img/fav.ico')}}" class="header-brand-img icon-logo" alt="{{env('APP_NAME')}}"> --}}
                            <img src="{{ asset('frontend/img/logo.png') }}" class="header-brand-img main-logo"
                                alt="{{ env('APP_NAME') }}">
                            <img src="{{ asset('frontend/img/fav.ico') }}" class="header-brand-img icon-logo"
                                alt="{{ env('APP_NAME') }}">
                        </a><!-- logo-->
                ...
                <div class="tab-menu-heading siderbar-tabs border-0  p-0">
                    <div class="tabs-menu ">
                        <ul class="nav panel-tabs">
                            ...
                            <li><a href="javascript:void(0);" onclick="logout();" title="logout"><i
                                        class="fa fa-power-off fs-17"></i></a></li>
                        </ul>
                    </div>
                </div>
                            ...
                            if($identity) {
                                ...
                                <li>
                                    <a class="side-menu__item" href="{{ route('user.index') }}">
                                        <i class="side-menu__icon fa fa-users fs-17"></i><span
                                ...
                                <li>
                                    <a class="side-menu__item" href="{{ route('parties') }}">
                                        <i class="side-menu__icon fa fa-users fs-17"></i><span
                                            class="side-menu__label">Parties</span>
                                    </a>
                                </li>

                                <li>
                                    <a class="side-menu__item" href="{{ url('filter-list') }}">
                                        <i class="side-menu__icon fa fa-users fs-17"></i><span
                                            class="side-menu__label">Filters</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a class="side-menu__item" href="{{ route('state') }}">
                                        <i class="side-menu__icon fa fa-users fs-17"></i><span
                                            class="side-menu__label">State & City</span>
                                    </a>
                                </li>
                                ...
                                ?>
                                <li>
                                    <a class="side-menu__item" href="javascript:void(0);" onclick="logout();"
                                        title="logout">
                        ...
                        <div class="tab-content border-top">
                            <div class="tab-pane active" id="tab">
                                <div class="card-body p-0">
                                    <div class="header-user text-center mt-4 pb-4">
                                        <span class="avatar avatar-xxl brround"><img
                                                src="{{ __($identity ? $identity->profilePic : 'assets/images/users/female/33.png') }}"
                                        ...
                                        <div class="dropdown-item text-center font-weight-semibold user h3 mb-0">
                                            {{ __($identity ? $identity->displayName : 'Guest') }}</div>
                                        <small>{{ __($identity ? $identity->role->name : 'Guest') }}</small>
                                    </div>
                                    <div class="card-body border-top">
                                        <div class="row">
                                            <div class="col-4 text-center">
                                                <a class="" href="{{ Helper::dashboardLink() }}"><i
                                                        class="dropdown-icon mdi  mdi-view-dashboard fs-30 m-0 leading-tight"></i></a>
                                                <div>Dashboard</div>
                                            </div>
                                            <div class="col-4 text-center">
                                                <a class="" href="{{ route('setting.index') }}"><i
                                                        class="dropdown-icon mdi mdi-tune fs-30 m-0 leading-tight"></i></a>
                                                <div>Settings</div>
                                            </div>
                                            <div class="col-4 text-center">
                                                <a class="" href="javascript:void(0);" onclick="logout();"><i
